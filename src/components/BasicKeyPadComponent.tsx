...
class BasicKeyPadComponent extends Component <State> {
...
onClick = (button: string) => {
  ...
  if(button === "="){
    ...
    this.setState({
        result: this.props.result + button
    })
  }
};
...
backspace = () => {
this.setState({
    result: this.props.result.slice(0, -1)
})
};
  ...
  render() {
    return (
      <div className="button">
        ...
        <button name="CE" onClick={e => this.onClick(e.currentTarget.name)}>CE</button>
        <button name=")" onClick={e => this.onClick(e.currentTarget.name)}>)</button>
        <button name="C" onClick={e => this.onClick(e.currentTarget.name)}>C</button><br/>
        ...
        <button name="+" onClick={e => this.onClick(e.currentTarget.name)}>+</button><br/>
        ...
        <button name="*" onClick={e => this.onClick(e.currentTarget.name)}>x</button><br/>
...
export default BasicKeyPadComponent;